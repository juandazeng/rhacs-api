                            ...
                            try:
                                ...
                                for cveId in cves:
                                    ...
                                    writer.writerow([
                                        ...
                                        ubiRelease,
                                        cve["cve"],
                                        "Fixable" if "fixedBy" in cve else "Not Fixable",
                                        severity,
                                        "{0:.1f}".format(cve["cvss"]),
                                        "{0:.2f}".format(cve["cvssV3"]["impactScore"]) if cve["cvssV3"] is not None else "0.00",
                                        cve["publishedOn"] if cve["publishedOn"] is not None else "",
                                        cve["firstSystemOccurrence"],
                                        cve["link"],
                                        cve["summary"]
                                    ])
                                    f.flush()
